        ...
        },
        {
            ...
            onClick: async () => {
                ...
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/plans/${year}/${month}/expenses`, {
                        method: 'POST',
                        headers: headers,
                        body: JSON.stringify(data)
                    });
                    ...
                    if (!response.ok) {
                        const error = await response.json();
                        throw new Error(error.detail || 'Ошибка при добавлении расхода');
                    }
        ...
        },
        {
            ...
            onClick: async () => {
                ...
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/plans/${year}/${month}/paid`, {
                        method: 'POST',
                        headers: headers,
                        body: JSON.stringify(data)
                    });
                    ...
                    if (!response.ok) {
                        const error = await response.json();
                        throw new Error(error.detail || 'Ошибка при отметке расхода');
                    }
