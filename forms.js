        ...
        },
        {
            ...
            onClick: async () => {
                ...
                try {
                    ...
                    showNotification('Доход успешно добавлен! Обновление данных...', 'success');
                    ...
                    if (onSuccess) {
                        // Вызываем loadData с forceRefresh = true
        ...
        },
        {
            ...
            onClick: async () => {
                ...
                try {
                    ...
                    showNotification('Расход успешно добавлен! Обновление данных...', 'success');
